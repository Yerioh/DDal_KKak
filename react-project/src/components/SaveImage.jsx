...
const SaveImage = () => {
  ...
  const [testIndex, setTestindex] = useState(null); // 이미지 인덱스 state
  ...
  const handleSelectAllChange = (e) => {
    setSelectAll(e.target.checked); // 전체 선택 상태 업데이트
  };
    ...
    <div className="SaveImage">
      ...
      <div className="S-Ibox">
        ...
        <ImgModal
          ...
          Img_data={testData} // 이미지 url
          index={testIndex} // 이미지 데이터 index
        />
      </div>
      {delImg ? (
